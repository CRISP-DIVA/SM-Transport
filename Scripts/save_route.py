...
#Script Pràcticament igual que el get_dens.py però en comptes de guardar les dades en una llista,
# s'incrementa el valor de densitat a la bd(per evitar conflictes)
def save_route():
    d = datetime.now()
    ...
    with db.connect() as conn:
        ...
        for step in steps:
            travel_modes.append(step['travel_mode'])
            coords = step['path']
